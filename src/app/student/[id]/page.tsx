...
const StudentDetails = () => {
    ...
    return (
        <div className="bg-[var(--color-secondary)] p-4 sm:p-6 w-full  mx-auto">
            ...
            {/* Header Section */}
            <div className="bg-[var(--color-primary)] relative px-5 sm:px-7 py-10 sm:py-12 rounded-lg">
                ...
                <div className="border-4 border-[var(--color-accent4)] w-24 h-24 rounded-full absolute top-8 left-5 sm:left-7 z-50 bg-[var(--bg-background)] overflow-hidden">
                    {student.imageUrl && (
                        <Image
