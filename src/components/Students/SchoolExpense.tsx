...
const StudentList = () => {
    ...
    return (
        <>
            <div className="p-5 bg-[var(--bg-background)] mt-6 rounded-lg lg:min-h-[750px]">
                ...
                {loading ? (
                    ...
                    <>
                        {currentStudent.map((student) => (
                            <div
                                className="grid grid-cols-1 sm:grid-cols-[2.5fr_1.5fr_0.5fr] max-md:shadow-sm p-3 gap-3 items-center mt-7"
                                key={student.id}
                            >
                                <div className="flex items-center gap-4">
                                    <span
                                        className="bg-[var(--color-red)] rounded-full p-3 text-white"
                                        aria-label="Student expense icon"
                                    >
                                        <TrendingUp size={22} />
                                    </span>
                                ...
                                <div className="text-sm text-[var(--color-accent2)] font-bold">
                                    ${student.price}
                                </div>
